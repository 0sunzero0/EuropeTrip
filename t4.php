...
<div class="w3-top">
  <div class="w3-row w3-padding w3-black">
    ...
    <div class="w3-col s3">
      <a href="#menu" class="w3-button w3-block w3-black">MYPAGE</a>
    </div>
    <div class="w3-col s3">
	...
	<p><i>나이순 히스토리</i></p>
 	<?php
	  ...
	  while($ordAge = mysqli_fetch_array($ordAgeR)){
		  ...
		  <div class="historyAge" id="HA<?php echo $ordAge['history_id'];?>" style="padding:5px; margin:10px; height:100px; overflow:scroll;">
		    <div style="display:inline-block; width:100%;">
		    <?php
		    if($ordAge['age']<20){
				...
				echo "<p>#",$ordAge['history_order'],"<br>Taken time: ", $ordAge['takentime'],"<br>Where: ", $ordAge['title'], "[", $ordAge['content'], "] </p>";
...
document.getElementById("myLink").click();
  ...
  $(document).ready(function(){
    ...
    $(".star_button").click(function(){
                ...
                if("<?echo $email ?>" != ""){
                  var id = $(this).attr('id');
                  var value1 ='<?echo $email ?>';
                  var value2 = $('input[name='+id+']').val();

                  var Data = {email:value1, team: value2};
