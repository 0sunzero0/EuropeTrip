    ...
    <div class="w3-content" style="max-width:700px">
      ...
      <div id="Drinks" class="w3-container menu w3-padding-48 w3-card">
					<?php
					  ...
					  history_user AS hu,
					  user AS u
					  WHERE u.user_id = $user_id AND h.historyUser_id = hu.historyUser_id AND u.user_id = hu.user_id AND hc.category_id = h.category;";
					  $user_historyR = mysqli_query($conn, $user_historyQ);
					  while($user_history = mysqli_fetch_array($user_historyR)){ ?>

							<h5>Title</h5>
							<p class="w3-text-grey"><?php echo $user_history['historyUser_title'];?></p><br>

							<h5>History order</h5>
							<p class="w3-text-grey"><?php echo $user_history['history_order'];?></p><br>

							<h5>Taken time</h5>
							<p class="w3-text-grey"><?php echo $user_history['takentime'];?> | <?php echo $user_history['nights'];?>nights <?php echo $user_history['days'];?>days</p><br>

							<h5>Where</h5>
							<p class="w3-text-grey"><?php echo $user_history['title'];?></p><br>

							<h5>Kinds</h5>
							<p class="w3-text-grey"><?php echo $user_history['content'];?></p>
